-- ========================================
-- ADMIN SCHEMA + RBAC MIGRATION (Trigger Fix)
...
-- 12. Fixed audit trigger for profile changes (handles both INSERT and UPDATE)
...
BEGIN
    ...
    -- Log INSERT operations by admins
    IF TG_OP = 'INSERT' AND public.can_manage_users() THEN
        INSERT INTO public.admin_audit (actor, action, target, metadata)
        VALUES (
            auth.uid(),
            'CREATE_PROFILE',
