...
-- Update public_medical_events sync function to exclude contact information completely
-- Drop all dependent objects with CASCADE
DROP FUNCTION IF EXISTS public.sync_public_medical_event() CASCADE;

-- Recreate the function with proper contact exclusion
