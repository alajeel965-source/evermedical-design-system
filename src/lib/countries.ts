...
export const countries: Country[] = [
  ...
  { code: "CD", name_en: "Congo (Democratic Republic)", name_ar: "جمهورية الكونغو الديمقراطية" },
  ...
  { code: "KP", name_en: "Korea (North)", name_ar: "كوريا الشمالية" },
  { code: "KR", name_en: "Korea (South)", name_ar: "كوريا الجنوبية" },
...
export const getCountriesByLanguage = (language: 'en' | 'ar'): Country[] => {
